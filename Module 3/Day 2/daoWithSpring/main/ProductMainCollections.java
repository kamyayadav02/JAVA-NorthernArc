...
import dao.ProductDaoImplCollections;
...
public class ProductMainCollections {
    ...
    public static void main(String[] args) {
        ...
        ProductDao productDao = new ProductDaoImplCollections();
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    Product newProduct = new Product(id, name, brand, category);
                ...
                case 3:
                    ...
                    Product updated = new Product(updateId, newName, newBrand, newCategory);
